...
int get_interval_from_guess(const double * const arr, NI_SIZE_T N,
                            double t, NI_SIZE_T i){
    ...
    NI_SIZE_T h; // step in finite difference estimate of derivative
    NI_SIZE_T di; // Delta i (update step in root finding)
    double dtdi; // derivative
...
int get_interval(const double * const arr, const NI_SIZE_T N, double t){
